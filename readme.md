...
Posterno component that registers custom Gutenberg blocks.

## Installation

This is a development repository for the blocks component and requires no installation for production sites because it's integrated within Posterno's core plugin.
